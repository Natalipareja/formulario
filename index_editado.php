...
<div class="container ">
    ...
    <div class="m-3">
    <!--  -->
        <button type="button" class="btn btn-primary btn-lg " data-bs-target="#collapse1"data-bs-toggle="collapse" aria-controls="collapse1" aria-expanded="false" >
            <h1>1. Información de la labor</h1>
         </button>
    ...
    <div class="m-3">
        <!-- colapsable 2 -->
        <button type="button" class="btn btn-primary btn-lg" data-bs-target="#collapse2"data-bs-toggle="collapse" aria-controls="collapse2" aria-expanded="false">
            <h1>2.Información del peligro</h1></button>
        <!-- colapsable 2 -->
        ...
        <div class="collapse" id="collapse2">
                ...
                <!-- <fieldset> -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_biologico" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_fisico" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_quimico" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_psicosocial" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_biomecanico" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_condiciones" name="descripcion" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" class="descripcion-peligro hidden" id="descripcion_fenomenos" name="descripcion" required>
    ...
    <div class="m-3">
        <!-- colapsable 3 -->
            <button type="button" class="btn btn-primary btn-lg" data-bs-target="#collapse3"data-bs-toggle="collapse" aria-controls="collapse3" aria-expanded="false"><h1>3.Controles existentes</h1></button>
    ...
    <div class="m-3">
        <!-- colapsable 4 -->
        <button type="button" class="btn btn-primary btn-lg" data-bs-target="#collapse4"data-bs-toggle="collapse" aria-controls="collapse4" aria-expanded="false"><h1>4.Evaluación del riesgo</h1></button>
    ...
    <div class="m-3">
        <!-- colapsable 5 -->
        <button type="button" class="btn btn-primary btn-lg" data-bs-target="#collapse5"data-bs-toggle="collapse" aria-controls="collapse5" aria-expanded="false"><h1>5.Medidas de intervención</h1></button>
...
<script>
  ...
  var listaDependiente = document.getElementById('descripcion');

  // Limpia las opciones existentes
  listaDependiente.innerHTML = '';

  // Agrega nuevas opciones basadas en la selección de la lista principal
  if(valorSeleccionado == 'biologico') {
    decripcion.innerHTML = '<option>Hongos</option><option>Bacterias</option><option>Ricketsias</option><option>Parásitos</option><option>Picaduras</option><option>Mordeduras</option><option>Fluidos o excrementos</option>';
  } else if(valorSeleccionado == 'fisico') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
  } else if(valorSeleccionado == 'quimico') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
 } else if(valorSeleccionado == 'psicosocial') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
} else if(valorSeleccionado == 'biomecanico') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
} else if(valorSeleccionado == 'condiciones de seguridad') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
} else if(valorSeleccionado == 'fenomenos naturales') {
    listaDependiente.innerHTML = '<option>Subopción 2-1</option><option>Subopción 2-2</option>';
